...
#ifndef __AI_AltarSwitchLatentActions_H
#define __AI_AltarSwitchLatentActions_H
...
namespace AI 
{
	...
	*/
	class CLA_AltarSwitch : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLA_AltarSwitch(CEntity* entity) : CLatentAction() {this->setEntity(entity);};

		CLA_AltarSwitch(CEntity* entity, std::string anim) : CLatentAction() {this->setEntity(entity); this->setStartingAnimation(anim);};
		/**
		Destructor
		*/
		~CLA_AltarSwitch() {};
