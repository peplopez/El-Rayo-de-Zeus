...
//////////////////////////////
	...
	al OnStop().
	*/
	CLatentAction::LAStatus CLA_Alert::OnStart()
	{
	...
	*/
	CLatentAction::LAStatus CLA_Alert::OnRun() 
	{
	...
	de OnStop().
	*/
	CLatentAction::LAStatus CLA_Alert::OnAbort() 
	{
	...
	por ese mensaje.
	*/
	bool CLA_Alert::accept(const CMessage *message)
	{		
	...
	*/
	void CLA_Alert::process(CMessage *message){}
	
	void CLA_Alert::tick(unsigned int msecs) 
	{		
		CLatentAction::tick();
	}

	void CLA_Alert::sleepComponents(){}

	void CLA_Alert::awakeComponents(){}
} //namespace LOGIC