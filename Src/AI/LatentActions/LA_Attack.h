...
namespace AI 
{
	...
	*/
	...
	public:
		...
		*/
		CLA_Attack(CEntity* entity,unsigned short initialCombatState) : CLatentAction(),_comboOportunity(false) {this->setEntity(entity);_initialCombatState=initialCombatState;_comboOportunity=false;};
		/**
		Destructor
		*/
		~CLA_Attack() {};
