...
#ifndef __AI_CHANGEBASELatentActions_H
#define __AI_CHANGEBASELatentActions_H
...
namespace AI 
{
	...
	*/
	class CLA_ChangeBase : public CLatentAction, public Application::IClockListener
	{
	public:
		/**
		Constructor.
		...
		*/
		CLA_ChangeBase(CEntity* entity) : CLatentAction(),_maxChangingBaseTime(2500) {this->setEntity(entity);};
		/**
		Destructor
		*/
		~CLA_ChangeBase() {};
...
#endif // __AI_CHANGEBASELatentActions_H