...
#ifndef __AI_BEATENLatentActions_H
#define __AI_BEATENLatentActions_H
...
namespace AI 
{
	...
	*/
	class CLA_Beaten : public CLatentAction
	{
	public:
		/**
		Constructor.
		...
		*/
		CLA_Beaten(CEntity* entity) : CLatentAction() {this->setEntity(entity);};
		/**
		Destructor
		*/
		~CLA_Beaten() {};
...
#endif // __AI_BEATENLatentActions_H