...
*/
	...
	public:
		...
		defecto.
		*/
		CAvatarController() : IComponent(GetAltTypeIdOf(CAvatarController)), _angularSpeed(0.00625f), _targetSense(Sense::UNDEFINED), _walkingRight(false), _walkingLeft(false), _acumRotation(0){}
