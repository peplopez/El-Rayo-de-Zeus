...
set IPHONEOS_DEPLOYMENT_TARGET 3.2
...
xcodebuild -project OGRE.xcodeproj -target doc -configuration Release -sdk iphoneos IPHONEOS_DEPLOYMENT_TARGET=3.2 GCC_VERSION=com.apple.compilers.llvm.clang.1_0
...
xcodebuild -project OGRE.xcodeproj -target install -parallelizeTargets -configuration Release -sdk iphoneos IPHONEOS_DEPLOYMENT_TARGET=3.2 GCC_VERSION=com.apple.compilers.llvm.clang.1_0
mkdir -p sdk/lib/Release-iphoneos
mv -v lib/Release/*.a sdk/lib/Release-iphoneos

echo Building for simulator...
xcodebuild -project OGRE.xcodeproj -target install -parallelizeTargets -configuration Release -sdk iphonesimulator IPHONEOS_DEPLOYMENT_TARGET=3.2 GCC_VERSION=com.apple.compilers.llvm.clang.1_0
