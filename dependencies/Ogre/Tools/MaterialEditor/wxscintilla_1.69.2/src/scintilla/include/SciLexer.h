...
#define SCLEX_OMS 79
#define SCE_OMS_DEFAULT 0
#define SCE_OMS_IDENTIFIER 1
#define SCE_OMS_PRIMARY 2
#define SCE_OMS_ATTRIBUTE 3
#define SCE_OMS_VALUE 4
#define SCE_OMS_NUMBER 5
#define SCE_OMS_OPERATOR 6
#define SCE_OMS_COMMENT 7
