...
function add_sdk_paths(t)
    ...
    if sfind(path, "^/") or sfind(path, "^%a:/") then
        ...
        librarypath(path.."/"..lib_suffix.."/debug")
        librarypath(path.."/"..lib_suffix.."/release")
    else
        include(rootdir..path.."/"..inc_suffix)
        librarypath(rootdir..path.."/"..lib_suffix)
        librarypath(rootdir..path.."/"..lib_suffix.."/debug")
        librarypath(rootdir..path.."/"..lib_suffix.."/release")
    end
end

--
-- Create a file with a name and a content if no other
-- file with that name exists or its contents is
-- different
-- Añadido por Marco Antonio Gomez. Ver comentario
-- en cegui.lua
--
